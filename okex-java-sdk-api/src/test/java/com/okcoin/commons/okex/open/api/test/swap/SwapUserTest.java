...
public class SwapUserTest extends SwapBaseTest {
    ...
    public void selectOrders() {
        String jsonObject = swapUserAPIServive.selectOrders("BTC-USD-SWAP", "0", "", "", "20");
        System.out.println("success");
        System.out.println(jsonObject);
    }
    ...
    public void selectOrderByOrderId() {
        String jsonObject = swapUserAPIServive.selectOrderByOrderId("BTC-USD-SWAP", "375845363402350593");
        System.out.println("success");
        System.out.println(jsonObject);
    }
    ...
    public void selectOrderByClientOid() {
        String jsonObject = swapUserAPIServive.selectOrderByClientOid("BTC-USD-SWAP", "ctt1128swap02");
        System.out.println("success");
        System.out.println(jsonObject);
    }
    ...
    public void getLedger() {
        String jsonArray = swapUserAPIServive.getLedger("BTC-USD-SWAP", "1", "", "30","");
        System.out.println("success");
        System.out.println(jsonArray);
    }

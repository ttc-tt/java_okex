...
public class SwapMarketTest extends SwapBaseTest {
    ...
    public void getDepthApi() {
        //size控制深度档位
        String depthApi = swapMarketAPIService.getDepthApi(instrument_id, "5","1");
    ...
    public void getTradesApi() {
        String tradesApi = swapMarketAPIService.getTradesApi(instrument_id, "", "", "5");
    ...
    public void getCandlesApi() {
        ...
        String start = "";
        String end = "";
        String candlesApi = swapMarketAPIService.getCandlesApi(instrument_id, start, end, "60");
    ...
    public void getHistoricalFundingRateApi() {
        String historicalFundingRateApi = swapMarketAPIService.getHistoricalFundingRateApi(instrument_id, "1");

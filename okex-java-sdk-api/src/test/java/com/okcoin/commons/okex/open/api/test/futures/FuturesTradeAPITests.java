...
public class FuturesTradeAPITests extends FuturesAPIBaseTests {
    ...
    public void testChangeLeverageOnFixed() {
        ...
        JSONObject jsonObject = tradeAPIService.changeLeverageOnFixed("BTC-USD", "BTC-USD-191227", "long", "15");
    ...
    public void testChangeLeverageOnCross() {
        JSONObject jsonObject = tradeAPIService.changeLeverageOnCross("BTC-USD", "28");
    ...
    public void testGetAccountsHoldsByinstrument_id() {
        JSONObject ledger = tradeAPIService.getAccountsHoldsByInstrumentId("XRP-USD-191227");
        toResultString(LOG, "Ledger", ledger);
    }
    ...
    public void testOrder() {
        ...
        order.setClient_oid("ctt1128test01");
        order.setType("1");
        order.setPrice("6500");
        order.setSize("1");
    ...
    public void testOrders() {
        ...
        item1.setClient_oid("ctt1128orders01");
        ...
        item2.setClient_oid("ctt1128orders02");
        item1.setOrder_type("0");
        item2.setType("1");
        item2.setPrice("6600");
        item2.setSize("1");
    ...
    public void testGetOrders() {
        JSONObject result = tradeAPIService.getOrders("BTC-USD-191227", "-1", "", "", "");
    ...
    //3932093177765889
        JSONObject result = tradeAPIService.getOrderByOrderId("BTC-USD-191227", "3932093177765889");
    ...
    public void testGetOrderByClientOid() {
        //3932093177765889
        JSONObject result = tradeAPIService.getOrderByClientOid("BTC-USD-191227", "ctt1128test1");
        toResultString(LOG, "Get-Order", result);
    }
    ...
    public void testCancelOrderByOrderId() {
        ...
        JSONObject result = tradeAPIService.cancelOrderByOrderId("BTC-USD-191227", "3932093177765889");
        toResultString(LOG, "Cancel-Instrument-Order", result);
    }
    @Test
    public void testCancelOrderByClientOid() {
        JSONObject result = tradeAPIService.cancelOrderByClientOid("BTC-USD-191227","ctt1128test1");
        toResultString(LOG, "Cancel-Instrument-Order", result);
    }
    ...
    public void testCancelOrdersByOrderId() {
        ...
        //通过订单号撤销订单
        list.add("3932275320003589");
        list.add("3932275320003587");
        cancelOrders.setOrder_ids(list);
        JSONObject result = tradeAPIService.cancelOrders("BTC-USD-191227", cancelOrders);
    ...
    public void testCancelOrdersByClientOid() {
        ...
        List<String> list = new ArrayList<String>();
        //通过client_oid撤销订单
        list.add("ctt1128orders01");
        list.add("ctt1128orders02");
    ...
    public void testGetFills() {
        ...
        JSONArray result = tradeAPIService.getFills("BTC-USD-191227", "", "", "", "");
    ...
    public void testFuturesOrder(){
        ...
        futuresOrderParam.setTrigger_price("6700");
        futuresOrderParam.setOrder_type("1");
        futuresOrderParam.setAlgo_price("6600");

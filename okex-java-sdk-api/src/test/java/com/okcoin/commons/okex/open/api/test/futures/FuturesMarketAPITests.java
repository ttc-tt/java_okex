...
public class FuturesMarketAPITests extends FuturesAPIBaseTests {
    ...
    public void testGetInstrumentBook() {
        Book book = marketAPIService.getInstrumentBook("BTC-USD-191227", "5","0.1");
    ...
    public void testGetInstrumentTrades() {
        List<Trades> trades = marketAPIService.getInstrumentTrades("BTC-USD-191227", "", "", "");
...
//        String end = "2019-07-15T03:15:00.000Z";
        JSONArray array = marketAPIService.getInstrumentCandles("BTC-USD-191227",
                                                                "",
                                                                "",
                                                                "60");
    ...
    public void testGetInstrumentLiquidation() {
        List<Liquidation> liquidations = marketAPIService.getInstrumentLiquidation("BTC-USD-191227", "1", "", "", "");
    ...
    public void testGetHolds() {
        Holds holds = marketAPIService.getHolds("BTC-USD-190719");
        toResultString(LOG, "Instrument-Holds", holds);
    }
}
